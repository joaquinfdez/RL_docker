...
xhost +local:dockerimdea_v_1612
sudo docker start  dockerimdea_v_1612
sudo docker exec -u 0  -it dockerimdea_v_1612 /bin/bash -rcfile /opt/swak4Foam/setImage_v1612+swakPyFoam
