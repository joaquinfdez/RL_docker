...
# Description
#      This script will
#          1) Start the OpenFOAM container with name 'of_v1612'
...
xhost +local:hfdresearch_v_1612
sudo docker start  hfdresearch_v_1612
sudo docker exec -u 0  -it hfdresearch_v_1612 /bin/bash -rcfile /opt/swak4Foam/setImage_v1612+swakPyFoam
